...
// Brand logomark. Uses `currentColor` so it inherits text color from its
// wrapper (e.g. `text-accent-foreground`, `text-primary-foreground`) and
// works across themes without a hardcoded fill.
export function PropPulseLogo(props: SVGProps<SVGSVGElement>) {
  return (
